...
| [Facility progress](facility-progress-spec.md) | Per-facility matches done, matches left and estimated finish time on the Control Center's Live Matches tab, plus a one-line version with a stale-data flag in Mission Control | Nothing |
